<template>
  <footer class="container px-6 py-10 mx-auto p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div class="md:flex md:justify-between">
      <div class="flex flex-col">
        ...
        <div>
          <p class="strong">Book safely and pay securely</p>
      ...
      <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
        <div>
          ...
          <ul class="text-gray-600 dark:text-gray-400">
            <li class="mb-4">
              <nuxt-link to="#" class="hover:underline">Parkos</nuxt-link>
            </li>
            <li>
              <nuxt-link to="#" class="hover:underline">Parkos.</nuxt-link>
            </li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
        >© 2022
        <nuxt-link to="https://flowbite.com/" class="hover:underline">Parkos</nuxt-link>.
        All Rights Reserved.
      </span>
      <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
        <nuxt-link to="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
